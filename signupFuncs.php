...
$kanri_flg = filter_input( INPUT_POST, "position" );
...
//３．データ登録SQL作成
$sql = "INSERT INTO user_db(employeeId,team,fullName,lpw,kanri_flg,life_flg)VALUES(:employeeId,:team,:fullName,:lpw,:kanri_flg,0)";
$stmt = $pdo->prepare($sql);
$stmt->bindValue(':employeeId', $employeeId, PDO::PARAM_STR); //Integer（数値の場合 PDO::PARAM_INT)
